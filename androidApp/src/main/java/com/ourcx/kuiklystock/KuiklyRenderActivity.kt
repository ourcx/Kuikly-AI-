...
import com.ourcx.kuiklystock.adapter.KRFontAdapter
import com.ourcx.kuiklystock.adapter.KRImageAdapter
import com.ourcx.kuiklystock.adapter.KRLogAdapter
import com.ourcx.kuiklystock.adapter.KRRouterAdapter
import com.ourcx.kuiklystock.adapter.KRThreadAdapter
import com.ourcx.kuiklystock.adapter.KRUncaughtExceptionHandlerAdapter
import com.ourcx.kuiklystock.module.KRBridgeModule
import com.ourcx.kuiklystock.module.KRShareModule
...
class KuiklyRenderActivity : AppCompatActivity(), KuiklyRenderViewBaseDelegatorDelegate {
    ...
    private val pageName: String
        get() {
            ...
            return if (pn.isNotEmpty()) pn else DEFAULT_PAGE_NAME
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        kuiklyRenderViewDelegator.onAttach(hrContainerView, "", pageName, argsToMap())
    }
    ...
    companion object {
        ...
        private const val DEFAULT_PAGE_NAME = "StockHome"
